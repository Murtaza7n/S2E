{{-- Enhanced Global Footer Component --}}
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
            ...
            <div class="flex flex-col">
                <div class="flex items-center space-x-3 mb-4">
                    <img src="{{ asset('images/logo/s2e-logo.svg') }}" alt="S2E Logistics" class="h-10 w-auto">
                    <div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('dashboard') }}" class="text-sm hover:underline transition-colors" style="color: #E5E7EB;">
                            Dashboard
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('s2e.cn-entry.index') }}" class="text-sm hover:underline transition-colors" style="color: #E5E7EB;">
                            CN Entry
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('finance.chart-of-accounts.index') }}" class="text-sm hover:underline transition-colors" style="color: #E5E7EB;">
                            Finance
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('settings.users.index') }}" class="text-sm hover:underline transition-colors" style="color: #E5E7EB;">
                            Settings
                        </a>
                    </li>
                </ul>
        ...
        <div class="border-t pt-6" style="border-color: rgba(255, 107, 53, 0.3);">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
                <p class="text-sm font-medium" style="color: #E5E7EB;">
                    &copy; {{ date('Y') }} <strong style="color: #FF6B35;">S2E Logistics</strong>. All rights reserved.
                </p>
