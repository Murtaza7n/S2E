        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="consignor_address" rows="2"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-s2e-orange focus:ring-s2e-orange">{{ old('consignor_address') }}</textarea>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="consignee_address" rows="2"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-s2e-orange focus:ring-s2e-orange">{{ old('consignee_address') }}</textarea>
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="remarks" rows="3"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-s2e-orange focus:ring-s2e-orange">{{ old('remarks') }}</textarea>
            </div>
        </div>
