...
@section('title', 'Edit Employee Loan')

@section('content')
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Edit Employee Loan</h1>
        <a href="{{ route('payroll.loans.index') }}" class="text-gray-600 hover:text-gray-800">← Back</a>
    </div>

    <div class="bg-white rounded shadow p-6">
        <form action="{{ route('payroll.loans.update', $loan) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="loan_type" value="{{ old('loan_type', $loan->loan_type) }}" 
                ...
                <div>
                    ...
                    <input type="number" name="loan_amount" step="0.01" min="0" value="{{ old('loan_amount', $loan->loan_amount) }}" 
                ...
                <div>
                    ...
                    <input type="number" name="installment_amount" step="0.01" min="0" value="{{ old('installment_amount', $loan->installment_amount) }}" 
                ...
                <div>
                    ...
                    <input type="date" name="start_date" value="{{ old('start_date', $loan->start_date?->format('Y-m-d')) }}" 
                ...
                <div>
                    ...
                    <input type="date" name="end_date" value="{{ old('end_date', $loan->end_date?->format('Y-m-d')) }}" 
            ...
            <div class="mt-6 flex gap-4">
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-600-hover">Update Loan</button>
