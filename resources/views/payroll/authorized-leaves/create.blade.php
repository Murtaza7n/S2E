...
@section('title', 'Create Authorized Leave')

@section('content')
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Create Authorized Leave</h1>
        ...
        <form action="{{ route('payroll.authorized-leaves.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="total_leaves" min="0" value="{{ old('total_leaves') }}" 
            ...
            <div class="mt-6 flex gap-4">
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-600-hover">Create Leave</button>
